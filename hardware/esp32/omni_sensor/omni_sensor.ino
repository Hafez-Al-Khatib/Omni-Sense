 ...
 * ==================================
 * Hardware: ESP32 DevKit + ADXL345 MEMS accelerometer (SPI)
 *
 ...
 *   • Orifice leak whistle   (500–3000 Hz)
 *   • Crack propagation tick (transient 100–2000 Hz)
 *
 * ADXL345 KEY SPECS (SPI mode)
 * -----------------------------
 * ODR up to 3200 Hz (BW_RATE register 0x0F)
...
#define MQTT_HOST         "mqtt.omni-sense.io"
#define MQTT_PORT         8883
#define SENSOR_ID         "S-ESP32-001"
#define SITE_ID           "beirut/hamra"
#define FIRMWARE_VERSION  "edge-fw-esp32-v3-accel-2026.04"
...
-----BEGIN CERTIFICATE-----
# PASTE YOUR CA CERTIFICATE HERE (generated by scripts/gen_certs.sh)
-----END CERTIFICATE-----
)EOF";

static const char CLIENT_CERT[] PROGMEM = "";
static const char CLIENT_KEY[]  PROGMEM = "";
...
void setup() {
  ...
  Serial.printf("  FW      : %s\n", FIRMWARE_VERSION);
  Serial.printf("  Sensor  : ADXL345 SPI @ %d Hz (Z-axis)\n", SAMPLE_RATE);
  Serial.printf("  Frame   : %d samples = %.3f s\n", FRAME_SAMPLES,
                (float)FRAME_SAMPLES / SAMPLE_RATE);
  Serial.printf("  Nyquist : %d Hz\n", SAMPLE_RATE / 2);
